...
```javascript
// HTTP POST /pd/trigger/ (context path requires trailing slash; match exactly or Jetty returns 405) - Source Transformer returns the HTTP response body directly (no Response tab in 4.5.x)
var rawBody = '';
try {
